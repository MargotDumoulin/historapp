...
// Code from : https://github.com/AlexDunmow/y-supabase/blob/main/src/index.ts, and modified a bit
...
export default class SupabaseProvider extends EventEmitter {
	...
	onAwarenessUpdate({ added, updated, removed }: any) {
	...
	constructor(
		...
		if (typeof window !== 'undefined') {
			window.addEventListener('beforeunload', () => this.removeSelfFromAwarenessOnUnload(this.doc));
		} else if (typeof process !== 'undefined') {
			process.on('exit', () => this.removeSelfFromAwarenessOnUnload(this.doc));
		}
	...
	public destroy() {
		...
		if (typeof window !== 'undefined') {
			window.removeEventListener('beforeunload', () =>
				this.removeSelfFromAwarenessOnUnload(this.doc)
			);
		} else if (typeof process !== 'undefined') {
			process.off('exit', () => this.removeSelfFromAwarenessOnUnload(this.doc));
		}
